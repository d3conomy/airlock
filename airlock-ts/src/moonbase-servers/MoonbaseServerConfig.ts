...
const MoonbaseServerSettings = new Map<AirlockSetting['name'], AirlockSetting>([
...
class MoonbaseServerConfig {
    public settings: Map<AirlockSetting['name'], AirlockSetting> = MoonbaseServerSettings;
...
export {
    MoonbaseServerConfig,
    MoonbaseServerSettings
}